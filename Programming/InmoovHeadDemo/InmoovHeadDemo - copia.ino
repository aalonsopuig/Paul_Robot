...
byte LimitServoHeadTilt[]={30,100,175};
byte LimitServoEyesPan[]={100,120,130};
byte LimitServoEyesTilt[]={85,110,160};
byte LimitServoJaw[]={110,110,140};
...
void setup() { 
  ...
  ServoHeadTilt.attach(2);  // Set index servo to digital pin
  ServoHeadPan.attach(3);  // Set index servo to digital pin
  ServoJaw.attach(4);  // Set index servo to digital pin
  ServoEyesPan.attach(5);  // Set index servo to digital pin
  ServoEyesTilt.attach(6);  // Set index servo to digital pin
