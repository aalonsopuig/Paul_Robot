...
rh.thumb.map(0,180,180,100)
rh.index.map(0,180,155,80)
rh.majeure.map(0,180,165,70)
rh.ringFinger.map(0,180,165,65)
rh.pinky.map(0,180,165,95)
...
rh.thumb.setRest(10)
rh.index.setRest(10)
rh.majeure.setRest(10)
rh.ringFinger.setRest(10)
rh.pinky.setRest(10)
...
#i01.setHandSpeed("right", 1, 1, 1, 1, 1)
...
sleep(4)
i01.moveHand("right",0,0,0,0,180,0)
sleep(6)
