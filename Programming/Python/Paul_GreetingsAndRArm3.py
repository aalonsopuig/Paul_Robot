...
#	sleep(2)
	...
	i01.moveHead(Neck_Rest_Rel,Rothead_Rest_Rel)
	i01.moveArm("right",175,R_rotate_Rest_Rel,180,R_omoplate_Rest_Rel)
	sleep(5)
...
head.neck.map     	(0,180,Neck_Min,Neck_Max)
head.rothead.map  	(0,180,Rothead_Min,Rothead_Max)
head.jaw.map  		(0,180,Jaw_Min,Jaw_Max)
head.eyeX.map  	(0,180,EyeX_Min,EyeX_Max)
head.eyeY.map  	(0,180,EyeY_Min,EyeY_Max)

#Definition of rest position relative to Min/Max Angles (value 0 is the Min and 180 is the Max)
Neck_Rest_Rel=     	180 * (Neck_Rest - Neck_Min)		/ (Neck_Max - Neck_Min)
Rothead_Rest_Rel=	180 * (Rothead_Rest - Rothead_Min)	/ (Rothead_Max - Rothead_Min)
Jaw_Rest_Rel=  	180 * (Jaw_Rest - Jaw_Min)     	/ (Jaw_Max - Jaw_Min)
EyeX_Rest_Rel=  	180 * (EyeX_Rest - EyeX_Min)     	/ (EyeX_Max - EyeX_Min)
EyeY_Rest_Rel=  	180 * (EyeY_Rest - EyeY_Min)     	/ (EyeY_Max - EyeY_Min)

head.neck.setRest(Neck_Rest_Rel)
head.rothead.setRest(Rothead_Rest_Rel)
head.jaw.setRest(Jaw_Rest_Rel)
head.eyeX.setRest(EyeX_Rest_Rel)
head.eyeY.setRest(EyeY_Rest_Rel)
